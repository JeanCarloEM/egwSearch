...
- restrições: não ocultar fonte, fixture ou publicação canônica; remover do
  índice somente runtime comprovado e preservar arquivos locais necessários.
- aceite: ciclo de vida, isolamento, retenção, limpeza, clone limpo, CI,
  empacotamento e prevenção de reinclusão definidos.
