...
Todo XHTML editorial gerado DEVE ser XML bem-formado e livre de caractere de controle ou marcador interno do conversor; a validação DEVE rejeitar o EPUB antes da promoção quando qualquer seção não puder ser integralmente analisada por parser XML. [PENDENTE-CODIGO]
