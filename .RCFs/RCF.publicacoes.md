...
Checkpoint ausente inicia nova execução; checkpoint incompatível, ambíguo ou corrompido DEVE ser preservado em quarentena auditável e reconstruído automaticamente a partir de publicações, provas e prefixos locais inequivocamente válidos, sem apagar publicação canônica já promovida nem repetir rede evitável. [d042907]
`--restart` permanece como reinício humano explícito limitado ao escopo selecionado e DEVE descartar apenas checkpoints de runtime aplicáveis; sua existência NÃO PODE substituir a autorrecuperação de estado tecnicamente reparável. [d042907]
